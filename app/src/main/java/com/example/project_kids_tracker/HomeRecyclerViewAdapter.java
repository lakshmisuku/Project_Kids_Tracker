...
class HomeRecyclerViewAdapter extends RecyclerView.Adapter<HomeRecyclerViewAdapter.ViewHolder> {
    ...
    public HomeRecyclerViewAdapter(Context ctx, List<Address> addresses, String lG, String lT, String city) {
        this.ctx = ctx;
    ...
    public HomeRecyclerViewAdapter(Context ctx, String lG, String lT, String city) {
        this.ctx = ctx;
        this.lG = lG;
        this.lT = lT;
        this.city = city;
